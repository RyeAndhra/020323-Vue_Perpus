    ...
    <div>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div v-for="b in buku" :key="b.id_buku" class="col-md-6">
                            <div class="card card-dark card-outline">
                                <div class="card-body text-justify">
                                    <h6 class="font-weight-bold">{{ b.judul_buku }}</h6>
                                    <p class="card-text">by {{ b.pengarang }}</p>
                                    <button type="button" @click="GetDetail(b.id_buku)" class="btn btn-dark"
                                        data-bs-toggle="modal" data-bs-target="#EditModal"> Borrow </button>
                                </div>
                            </div>
                        </div>
                    </div>
